...
setenv PATH ${HOME}/bin:${HOME}/bin/acces/bash:${HOME}/bin/aster:${PREFIX_INSTALL}/bin:${PREFIX_INSTALL}/eclipse/eclipse-4.2:${PREFIX_INSTALL}/mendeleydesktop:${PREFIX_INSTALL}/firefox:${PREFIX_INSTALL}/nixnote:${PREFIX_INSTALL}/scilab-5.3.3/bin:${PYTHONHOME}/bin:${EXPL_DIR}/Subversion_1.7.4/SUBVERSION/bin:${BASEPATH}:.
